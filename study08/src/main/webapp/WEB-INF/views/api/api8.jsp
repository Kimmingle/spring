...
<body>
	<input type="text" name = "part" class="part" placeholder="반 이름 입력"/>
	<input type="number" name = "classNum" class="classNum" placeholder="반 번호 입력"/>
	<div class=form>
	...
	<script> //학생 객체들을 저장해서 team으로 보낼거임
